...
import { ExternalLink, Send, MapPin, Mail, Check, Loader2 } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <button
                  ...
                  className={`group flex items-center gap-3 px-10 py-4 border text-sm uppercase tracking-[0.15em] transition-all duration-300 ${
                    status === 'success'
                      ? 'border-green-500/40 text-green-400 cursor-default'
                      : status === 'sending'
                        ? 'border-[#C8C0B4]/30 text-[#C8C0B4]/50 cursor-wait'
                        : 'border-[#C8C0B4] text-[#C8C0B4] hover:bg-[#C8C0B4] hover:text-[#0A0A0A]'
                  }`}
                >
                  {status === 'sending' && (
                    <>
                ...
                {/* Success message */}
                {status === 'success' && (
                  <p className="text-green-400/80 text-sm font-[family-name:var(--font-mono)]">
                ...
                {/* Error message */}
                {status === 'error' && (
                  <p className="text-red-400/80 text-sm font-[family-name:var(--font-mono)]">
